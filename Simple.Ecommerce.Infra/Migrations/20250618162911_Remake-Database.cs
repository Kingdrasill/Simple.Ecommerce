    ...
    public partial class RemakeDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DescontoTiers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DescontoTiers_Descontos_DiscountId",
                        column: x => x.DiscountId,
                        principalTable: "Descontos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DescontoItensPacote", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DescontoItensPacote_Descontos_DiscountId",
                        column: x => x.DiscountId,
                        principalTable: "Descontos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DescontoItensPacote_Produtos_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProdutoFotos_Produtos_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Produtos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsuarioEnderecos_Usuarios_UserId",
                        column: x => x.UserId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItensPedido_Produtos_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Produtos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DescontoItensPacote_DiscountId",
                table: "DescontoItensPacote",
                column: "DiscountId");

            migrationBuilder.CreateIndex(
                name: "IX_DescontoItensPacote_ProductId",
                table: "DescontoItensPacote",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_DescontoTiers_DiscountId",
                table: "DescontoTiers",
                column: "DiscountId");

            migrationBuilder.CreateIndex(
                name: "IX_ItensPedido_OrderId_ProductId",
                table: "ItensPedido",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProdutoFotos_ProductId",
                table: "ProdutoFotos",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsuarioEnderecos_UserId",
