        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentName = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
                    PaymentKey = table.Column<string>(type: "longtext", nullable: true),
                    ExpirationMonth = table.Column<string>(type: "varchar(2)", maxLength: 2, nullable: true),
                    ExpirationYear = table.Column<string>(type: "varchar(5)", maxLength: 5, nullable: true),
                    CardFlag = table.Column<int>(type: "int", nullable: true),
                    Last4Digits = table.Column<string>(type: "longtext", nullable: true),
                    Deleted = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuariosPagamentos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsuariosPagamentos_Usuarios_UserId",
                        column: x => x.UserId,
                        principalTable: "Usuarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsuariosPagamentos_UserId",
                table: "UsuariosPagamentos",
                column: "UserId");
