...
namespace Simple.Ecommerce.Infra.Migrations
{
    ...
    [Migration("20250804143251_Adding-Coupon-To-Order-And-OrderItem")]
    partial class AddingCouponToOrderAndOrderItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Simple.Ecommerce.Domain.Entities.OrderEntity.Order", b =>
                {
                    b.HasOne("Simple.Ecommerce.Domain.Entities.CouponEntity.Coupon", "Coupon")
                        .WithOne("Order")
                        .HasForeignKey("Simple.Ecommerce.Domain.Entities.OrderEntity.Order", "CouponId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Simple.Ecommerce.Domain.Entities.OrderItemEntity.OrderItem", b =>
                {
                    b.HasOne("Simple.Ecommerce.Domain.Entities.CouponEntity.Coupon", "Coupon")
                        .WithOne("OrderItem")
                        .HasForeignKey("Simple.Ecommerce.Domain.Entities.OrderItemEntity.OrderItem", "CouponId")
                        .OnDelete(DeleteBehavior.Cascade);
